...
class MockDataFactory:
    ...
    def create_complete_bot_data(
        ...
        return {
            ...
            "meeting_url": "https://meet.google.com/abc-defg-hij",
            "status_changes": [
                {"code": "ready", "created_at": (start_time - timedelta(minutes=5)).isoformat() + "Z"},
                {"code": "in_call_recording", "created_at": start_time.isoformat() + "Z"},
...
class TestHelpers:
    ...
    def assert_meeting_status(meeting_data: Dict[str, Any], expected_status: str):
        ...
        assert meeting_data["status"] == expected_status, \
    ...
    def assert_bot_in_meeting(status_data: Dict[str, Any], expected: bool = True):
        ...
        assert status_data["in_meeting"] == expected, \
...
class MockRecallAPI:
    ...
    def __init__(
        ...
        self.transcript_data = transcript_data or MockDataFactory.create_transcript_data()
        self.participants_data = participants_data or MockDataFactory.create_participants_data()
        self.patches = []
